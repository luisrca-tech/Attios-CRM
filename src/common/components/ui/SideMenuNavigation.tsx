      ...
      <nav className="w-full">
        <ul className="flex min-h-full flex-col items-center justify-around">
          <li className="w-full">
            <button
              type="button"
              className="flex w-full items-center justify-center px-4 transition-all duration-300 pb-5"
            >
              <div className="flex gap-3">
                ...
                />
                {isHovered && (
                  <strong className="text-xl text-primary-100">Attios</strong>
                )}
              </div>
            </button>
          </li>
