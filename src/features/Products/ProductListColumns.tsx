...
export const productListColumns = ({
	...
	const columns: ColumnType<Product> = [
			...
			header: () => (
				<div className="flex items-center justify-between">
					...
					<OrdenationButton
						column="name"
						currentDirection={
							currentSort.column === 'name' ? currentSort.direction : undefined
						}
						onClick={() =>
							onSort(
								'name',
		...
		},
		{
			...
			cell: ({ row }) => {
				// Fixed sales values based on row index
		...
		},
		{
			...
			cell: ({ row }) => (
				<div className="font-bold">{row.original.modelYear}</div>
			)
		},
		{
